...
class CharacterEditorState extends MusicBeatState
{
	...
	function addAnimationsUI()
	{
		...
		var addUpdateButton:FlxButton = new FlxButton(animationImageInputText.x + animationImageInputText.width + 7, animationImageInputText.y - 3, "Add/Update", function() {
			...
			var addedAnim:AnimArray = newAnim(animationInputText.text, animationNameInputText.text, animationImageInputText.text);
	...
	override function update(elapsed:Float)
	{
		...
		if(animationInputText.hasFocus || animationNameInputText.hasFocus || animationIndicesInputText.hasFocus || imageInputText.hasFocus || healthIconInputText.hasFocus || vocalsInputText.hasFocus || animationImageInputText.hasFocus)
		{
	...
	function addAnimation(anim:String, name:String, fps:Float, loop:Bool, indices:Array<Int>, ?image:String)
	{
		if(!character.isAnimateAtlas)
		{
			var img = image;
